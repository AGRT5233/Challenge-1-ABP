...
loans = sum(loan_costs)
print (f"Total Value of loans equals ${loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan_amount = round(loans/number_of_loans, 2)
print (f"Average loan amount equals ${average_loan_amount}")

# Question : How do we set the values to go to 2 decimals in the calculation?
# round function
...
print("the loan price is", loan_price)
...
print('present value is', round(present_value,2))
# Students Comment ! I am assuming present value is fair value.
...
present_value = round(present_value(new_loan["future_value"], new_loan["remaining_months"], annual_discount_rate), 2)
...
with open(output_path, mode="w") as csv_file:
    loan_writer = csv.writer(csv_file, delimiter = ",")

    loan_writer.writerow(header)
    # loan_writer.writerows([inexpensive_loans])
